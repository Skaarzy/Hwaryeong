**Main Story = Railroad (unchangeable)**

- Demon war happens exactly as written
- Kings die on schedule
- Hwa-ryeol kills Falling Petal Immortal
- Hyeon-do kills King Cheonseong
- Tak-jin gets his revenge
- Dynasty falls, rises again

**Side Quests = Who Shows Up Later**

- Help Plum Blossom Sect in side quest → Plum Blossom reinforcements appear in main story battle
- Befriend Hong Chil-gong → Beggar Sect information network helps you
- Do Divine Seal Sect quests → They show up to help vs demons
- Ignore Iron Palm Sect → They don't aid you later

**Benefits:**

- **You write main story ONCE** - no branching complexity
- **Side quests add flavor** - relationships matter, choices have weight
- **Player agency feels real** - "I helped them, so they helped me"
- **Much easier to manage** - just flag "did player help X sect?" → they appear/don't appear

**Example:**

- **Main Story (Chapter 15):** "Battle at Capital - allies arrive to help"
    - _If_ player did Plum Blossom quests → they show up
    - _If_ player did Beggar Sect quests → they provide intel
    - _If_ player did neither → fight is harder but still winnable
- **Main plot outcome:** Battle succeeds either way (fixed)
- **Player experience:** "MY allies came because I earned their trust"

This is **standard RPG structure** and works perfectly. Story stays coherent, player choices matter without breaking narrative.
